...
class GameEngine:
    ...
    def init_evolutionary_ai(self):
        try:
            ...
            print(f"Warning: Evolutionary AI initialization failed: {e}")
    ...
    def evolve_ai_defense(self):
        try:
            if not self.toolbox or not self.population:
            ...
            print(f"Warning: AI evolution failed: {e}")
            # Fallback to random selection
            all_tools = ["SQL Injection", "XSS", "Brute Force", "ARP Poison", "Ping Flood", "DNS Tunneling", "Social Engineering"]
            return random.choice(all_tools)
    ...
    def fitness_function(self, individual):
        try:
            ...
            print(f"Warning: Fitness function failed: {e}")
